...
1. **Gather your hardware**
   ...
   ![Parts Overview](../../../assets/pre-build-parts.jpeg)
...
4. **Assemble the hardware**
   ...
   **Temperature node (TMP102)**
   ...
   ![TMP102 Wiring](../../../assets/tmp-diagram.jpg)
   ...
   **Pressure node (BMP280)**
   ...
   ![BMP280 Wiring](../../../assets/bmp-diagram.jpg)
...
7. **Run the monitor and connect to the receiver**
   ...
   ![Monitor Application](../../../assets/full-monitor-dashboard.png)
